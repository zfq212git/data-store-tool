...
var host = "aa1bqwq5yhn04m1.ccbgupkoczvm.us-east-1.rds.amazonaws.com";
var database = "test";
var user = "feiqizhang";
var password = "Feiqi-1030";
    ...
    async.waterfall([
        function (cb) {
            ...
            dbpool.query(
                ...
                ["POP", "1234567890"], function(err, result) {
                    if (err) {
                        console.log("constant insert failed either!" + err.message);
                    }
                }
            )
            ...
            dbpool.query(
                ...
                if (err) {
                    ...
                    callback(0);
                    if (err.number == 1062) {
                        console.log("unknown error-FZ");
                    } else {
                        console.log('running error-FZ000--' + err.message);
                    }
                } else if (result) {
                    // 正常
                    callback(1);
                    console.log("save ok-FZ");
                } else {
                    console.log('unknown running error-FZ');
                }
            });   
            cb(null);
        }
